...
<html lang="zxx">
<head>
	<title>Galery | PT Tri Ratna Diesel Indonesia</title>
	<meta charset="UTF-8">
...
<body>
		...
		<div class="site-navbar">
			...
			<nav class="site-nav-menu">
				<ul>
					...
					<li ><a>Unit</a>
						<ul class="sub-menu">
							<li><a href="<?php site_url();?>../home/unit_dem">DEM</a></li>
							<li><a href="<?php site_url();?>../home/unit_mc">MC</a></li>
							<li><a href="<?php site_url();?>">SM</a></li>
						</ul>
					</li>
					<li class="active"><a href="<?php site_url();?>">Galery</a></li>
	...
	<section class="about-section spad">
		<!-- <div class="container">
			<div class="row">
				<div class="col-lg-6">
					<img src="<?php site_url();?>../../assets/user/img/about.jpg" alt="">
				</div>
				<div class="col-lg-6">
					<div class="about-text">
						...
						<div class="about-sign">
							<div class="sign">
								<img src="<?php site_url();?>../../assets/user/img/sign.png" alt="">
							</div>
							<div class="sign-info">
								<h5>Michael Smith</h5>
