...
<head>
	...
	<!-- Favicon -->
	<link href="<?php site_url();?>../assets/user/img/favicon.ico" rel="shortcut icon"/>
	<!-- Google font -->
	...
	<link rel="stylesheet" href="<?php site_url();?>../assets/user/css/magnific-popup.css"/>
	...
	<header class="header-section clearfix">
		<div class="site-navbar">
			...
			<nav class="site-nav-menu">
				<ul>
					<li class="active"><a href="<?php base_url();?>Home">Beranda</a></li>
					...
					<li><a href="<?php base_url();?>Home/galery">Galery</a></li>
		...
		<div class="hero-slider owl-carousel">
			<div class="hero-item set-bg" data-setbg="<?php site_url();?>../assets/user/img/hero-slider/1.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-8">
							<h2><span>Tri Ratna Diesel</span><span>Indonesia</span></h2>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item">
							<div class="si-head">
								<div class="si-icon">
									<img src="<?php site_url();?>../assets/user/img/icons/helmet.png" alt="">
								</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item">
							<div class="si-head">
								<div class="si-icon">
									<img src="<?php site_url();?>../assets/user/img/icons/pollution.png" alt="">
								</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item">
							<div class="si-head">
								<div class="si-icon">
									<img src="<?php site_url();?>../assets/user/img/icons/pumpjack.png" alt="">
								</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item">
							<div class="si-head">
								<div class="si-icon">
									<img src="<?php site_url();?>../assets/user/img/icons/light-bulb.png" alt="">
								</div>
								<h5>Power & Energy</h5>
							</div>
							<p>Sodales in est quis, blandit sollicitudin est. Nam ornare ipsum ac accumsan auctor. Donec con-sequat arcu et commodo interdum. </p>
	...
	<section class="clients-section spad">
		<div class="container">
			<div class="client-text">
				<h2>Tri Ratna Diesel Indonesia</h2>
			...
			<div class="row">
				<div class="col-lg-8 col-md-6">
					<div class="footer-widget about-widget">
						<img src="<?php site_url();?>../assets/user/img/logo-light.png" alt="">
